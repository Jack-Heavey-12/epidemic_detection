...
def LinearProgram_baselines(H, graph, k, sources, paths):
	...
	s_r_greedy = greedy(graph, int(sum(x_prime_dict.values())), src, paths)
...
if __name__ == '__main__':
	...
	#for i in prob_lst:
		...
		obj_val_rounded, obj_val_degree, obj_val_random, obj_val_greedy, x_prime_dict, degree_set, random_nodes, s_r_greedy = LinearProgram_baselines(H, G, k, sources, paths)
		...
		textfile = open('baselines_files_5/final_output.csv', 'w')
